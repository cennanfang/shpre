...
import com.buliyiren.shpre.redis.RedisDataSource;
...
@Repository("redisClientTemplateBase")
public class RedisClientTemplateBase {

    private static final Logger log = LoggerFactory.getLogger(RedisClientTemplateBase.class);
